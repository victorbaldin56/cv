...
A derivative calculator with step-by-step solution. Creates AST for
math expression and evaluates a derivative by performing certain transformations on AST.\\
Link: \url{https://github.com/victorbaldin56/differenciator}
}

\CVItem{Miniprintf}{
Simple implementation of \texttt{printf} function in pure NASM assembly for x86-64
Linux.\\
...
As the result, on my machine search by key has been speeded up by 2.8 times.\\

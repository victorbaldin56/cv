...
As the result, on my machine search by key was speeded up by 2.8 times.\\
...
Supports dump as NASM assembly annotated with debug info. The other option is JIT native code execution.\\

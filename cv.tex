...
\cvheading{Baldin Viktor} % Large heading - your name
...
\aboutme{About Me}{
For the last year I have been learning low-level programming in C with a little use of C++ OOP.
}
